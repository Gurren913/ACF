...
E2Helper.Descriptions["acfActive"] = "Gets/sets Active (0-1) for an ACF engine or ammo crate."
...
E2Helper.Descriptions["acfCapacity"] = "Returns the capacity of an ACF ammo crate."
